...
/* Private defines -----------------------------------------------------------*/
#define IR11_LH_Pin GPIO_PIN_1
#define IR11_LH_GPIO_Port GPIOC
#define IR12_RH_Pin GPIO_PIN_2
#define IR12_RH_GPIO_Port GPIOC
#define LED3_Pin GPIO_PIN_8
#define LED3_GPIO_Port GPIOE
#define SERVO_PWM_Pin GPIO_PIN_15
#define SERVO_PWM_GPIO_Port GPIOB
#define USB_Raspberry_TX_Pin GPIO_PIN_8
#define USB_Raspberry_TX_GPIO_Port GPIOD
#define USB_Raspberry_RX_Pin GPIO_PIN_9
#define USB_Raspberry_RX_GPIO_Port GPIOD
...
#define TIM8_Echo_Pin GPIO_PIN_7
